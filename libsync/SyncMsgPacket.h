...
class SyncBlockForStoragePacket : public SyncMsgPacket
{
public:
    SyncBlockForStoragePacket() { packetType = BlockForStoragePacket; }
    void encode(dev::bytes const& _blockRLP);
};

class SyncDistributedTxPacket : public SyncMsgPacket
{
public:
    SyncDistributedTxPacket() { packetType = DistributedTxPacket; }
    void encode(dev::bytes const& _blockRLP);
};

class SyncPreCommittedTxPacket : public SyncMsgPacket
{
public:
    SyncPreCommittedTxPacket() { packetType = PreCommittedTxPacket; }
    void encode(dev::bytes const& _blockRLP);
};

class SyncCommittedTxPacket : public SyncMsgPacket
{
public:
    SyncCommittedTxPacket() { packetType = CommittedTxPacket; }
    void encode(dev::bytes const& _blockRLP);
};
