...
public:
    ...
    void initConfig(boost::property_tree::ptree const& _pt, std::shared_ptr<Service> _p2pService);
    void initConfig(boost::property_tree::ptree const& _pt, std::shared_ptr<Service> _p2pService, PROTOCOL_ID _group_protocolID);
...
private:
    ...
    std::vector<dev::GROUP_ID> initLedgers(std::shared_ptr<Service> _p2pService);
    std::vector<dev::GROUP_ID> initLedgers(std::shared_ptr<Service> _p2pService, PROTOCOL_ID _group_protocolID);
    ...
    bool initLedger(dev::GROUP_ID const& _groupId, std::shared_ptr<Service> _p2pService, std::string const& _dataDir = "data",
        std::string const& _configFileName = "");

    bool initLedger(dev::GROUP_ID const& _groupId, std::shared_ptr<Service> _p2pService, PROTOCOL_ID _group_protocolID, std::string const& _dataDir = "data",
        std::string const& _configFileName = "");
