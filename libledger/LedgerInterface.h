...
public:
    ...
    virtual bool initLedger(std::shared_ptr<LedgerParamInterface> _ledgerParams, std::shared_ptr<dev::p2p::Service> _p2pService) = 0;
    virtual bool initLedger(std::shared_ptr<LedgerParamInterface> _ledgerParams, std::shared_ptr<dev::p2p::Service> _p2pService, PROTOCOL_ID _group_protocolID) = 0;
