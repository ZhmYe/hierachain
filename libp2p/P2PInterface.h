...
class P2PSession;
typedef std::function<void(dev::network::NetworkException, std::shared_ptr<dev::p2p::P2PSession>, std::shared_ptr<dev::p2p::P2PMessage>)> CallbackFuncWithSession;
typedef std::function<void(dev::network::NetworkException, std::shared_ptr<dev::p2p::P2PSession>)> DisconnectCallbackFuncWithSession;
